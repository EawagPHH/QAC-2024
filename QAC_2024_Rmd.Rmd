...
ggplot(dat.n, aes(x = CT, y = log, fill = time_bins)) + 
...
lmTlog = lm(log~ log(CT, 10) + size10 + carbon + as.numeric(Temp) + Surface +  Gsize +  measurement + `ssRNA(-)` + ssDNA + `ssRNA(+)` + dsRNA + BZT + DDAB + DDAC  + others + QACmix, data = subset_LR)

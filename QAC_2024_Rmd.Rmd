...
```{r}
#Size
#dat$Surface <-ifelse(dat$Surface == 1, "e","n") 
...
# Fit the initial model including all columns
lmTlog = lm(log~ log(CT, 10) + S1 + S2+ S3 + carbon + T1+ T2 +T3+ T4 + Surface +     `ssRNA(-)` + ssDNA + `ssRNA(+)` + dsRNA + BZT + DDAB + DDAC  + others + QACmix, data = subset_LR)

# View the summary of the model
summary(lmTlog)

# Fit the initial model including all columns
lmTlog = lm(log~ log(CT, 10) + S1 + S2+ S3 + carbon + T1+ T2 +T3+ T4 + Surface +     `ssRNA(-)` + ssDNA + `ssRNA(+)` + dsRNA + BZT + DDAB + DDAC  + others + QACmix, data = dat.el)

# View the summary of the model
summary(lmTlog)# Fit the initial model including all columns
lmTlog = lm(log~ log(CT, 10) + S1 + S2+ S3 + carbon + T1+ T2 +T3+ T4 + Surface +     `ssRNA(-)` + ssDNA + `ssRNA(+)` + dsRNA + BZT + DDAB + DDAC  + others + QACmix, data = dat.nl)
...
subsetLM <-  subset(dat, (!is.na(dat$log)) &
                      is.na(material) & 
                      CT < 100000 &
                      QAC == "BAC" &
                      measurement == 1 &
...
# Fit the initial model including all columns
lmTlog = lm(logll ~ log(CT, 10) + size10 + carbon + as.numeric(Temp) + Surface +  measurement + `ssRNA(-)` + ssDNA + `ssRNA(+)` + dsRNA + BZT + DDAB + DDAC + others + QACmix, data = subsetLM)
